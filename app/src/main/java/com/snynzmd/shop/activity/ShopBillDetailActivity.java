...
import com.snynzmd.shop.adapter.ShopBillDetailProductAdapter;
...
public class ShopBillDetailActivity extends AppCompatActivity {
    @BindView(R.id.rv_shop_bill_detail_products)
    RecyclerView rvProducts;
    private ImmersionBar immersionBar;

    private ShopBillDetailProductAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ShopBillDetailProductAdapter(new ArrayList<ShopCartProduct>(),this);
    ...
    @OnClick(R.id.ll_shop_bill_detail_back)
    public void back() {
        finish();
    }
}

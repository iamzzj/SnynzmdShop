...
public class ShopProductChooseActivity extends AppCompatActivity implements ShopProductChooseProductTypeAdapter.OnItemClickListener {

    @BindView(R.id.rv_shop_product_choose_product_type)
    RecyclerView rvProductType;
    @BindView(R.id.rv_shop_product_choose_product)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_product_choose);
    ...
    @OnClick(R.id.ll_shop_product_choose_back)
    public void back() {
        finish();
    }
    ...
    @OnClick(R.id.iv_shop_product_choose_cart)
